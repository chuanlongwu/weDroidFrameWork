...
public class WedroidScrollView extends ScrollView {
	...
	public WedroidScrollView(Context context) {
		super(context);
		this.mContext = context;
	}

	public WedroidScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
	}

	public WedroidScrollView(Context context, AttributeSet attrs, int defStyle) {
...
//	}
	...
	interface WeDroidScrollerListener{
		void springBack();
	}
}