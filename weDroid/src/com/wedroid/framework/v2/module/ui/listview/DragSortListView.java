...
public class DragSortListView extends ListView {
     ...
     * a heavily wrapped ListAdapter (DragSortListView wraps the input
     * ListAdapter {\emph and} ListView wraps the wrapped one).
     */
    ...
    private void drawDivider(int expPosition, Canvas canvas) {
        ...
        // WedroidLog.d("mobeta", "div="+divider+" divH="+dividerHeight);
        ...
        if (divider != null && dividerHeight != 0) {
            ...
            if (expItem != null) {
                ...
                // WedroidLog.d("mobeta", "l="+l+" t="+t+" r="+r+" b="+b);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mFloatView != null) {
            ...
            canvas.save();
            // WedroidLog.d("mobeta", "clip rect bounds: " + canvas.getClipBounds());
    ...
    private boolean updatePositions() {
        ...
        if (mAnimate) {
            ...
            // WedroidLog.d("mobeta", "edgeTop="+edgeTop+" edgeBot="+edgeBottom);
    ...
    /**
     * Cancel a drag. Calls {@link #(boolean, boolean)} with <code>true</code>
    ...
    private void adjustOnReorder() {
        ...
        // WedroidLog.d("mobeta", "first="+firstPos+" src="+mSrcPos);
        if (mSrcPos < firstPos) {
            ...
            // WedroidLog.d("mobeta", "top="+top+" fvh="+mFloatViewHeight);
    ...
    private int getChildHeight(int position) {
        ...
        if (v != null) {
            ...
            if (childHeight != -1) {
                // WedroidLog.d("mobeta", "found child height in cache!");
                return childHeight;
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // WedroidLog.d("mobeta", "onMeasure called");
        if (mFloatView != null) {
    ...
    protected boolean onDragTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_CANCEL:
                ...
                break;
            case MotionEvent.ACTION_UP:
                // WedroidLog.d("mobeta", "calling stopDrag from onDragTouchEvent");
                if (mDragState == DRAGGING) {
                    stopDrag(false);
                }
                doActionUpOrCancel();
     ...
     * {@link #startDrag(int, android.view.View,int,int,int)} after obtaining
    ...
    private void doDragFloatView(int movePos, View moveItem, boolean forceInvalidate) {
        ...
        if (updated) {
            ...
            // WedroidLog.d("mobeta", "  adjust scroll="+scroll);
    ...
    private void updateFloatView() {
        ...
        // WedroidLog.d("mobeta", "dragView top=" + (y - mDragDeltaY));
        // WedroidLog.d("mobeta", "limit=" + limit);
        // WedroidLog.d("mobeta", "mDragDeltaY=" + mDragDeltaY);
    ...
    public interface FloatViewManager {
         ...
         * {@link android.view.ViewGroup.LayoutParams} on this View; otherwise
         * it will set some for you (with a width of FILL_PARENT and a height of
         * WRAP_CONTENT).
         * 
         * @param position Position of item to drag (NOTE: <code>position</code>
         *            excludes header Views; thus, if you want to call
         *            {@link android.widget.ListView#getChildAt(int)}, you will
         *            need to add
         *            {@link android.widget.ListView#getHeaderViewsCount()} to
         *            the index).
     ...
     * determines how If disabled, items cannot be dragged.
     * 
     ...
     * {@link android.widget.BaseAdapter#notifyDataSetChanged()} or something
     * like it is called in your implementation. Furthermore, if you have a
     * choiceMode other than none and the ListAdapter does not return true for
     ...
     * {@link android.widget.BaseAdapter#notifyDataSetChanged()} or something
     * like it. When an item removal occurs, DragSortListView relies on a redraw
     * of all the items to recover invisible views and such. Strictly speaking,
     * if you remove something, your dataset has changed...
     * 
     * @param l
     */
     ...
     * call {@link android.widget.BaseAdapter#notifyDataSetChanged()} or
     * something like it in your implementation.
     * 
     * @author heycosmo
     */
     ...
     * {@link android.widget.ListAdapter#hasStableIds()}). This is because
     * without IDs, the ListView has no way of knowing which items have moved
     * where, and cannot update the check state accordingly.
     * <p>
     ...
     * {@link android.widget.ListAdapter#hasStableIds()}). This is because
     * without IDs, the ListView has no way of knowing which items have moved
     * where, and cannot update the check state accordingly. See also further
     * comments on {@link #moveCheckState(int, int)}.
     * 
     * @param position
     */
    ...
    private class DragScroller implements Runnable {
        ...
        public void run() {
            ...
            if (scrollDir == UP) {
                View v = getChildAt(0);
                // WedroidLog.d("mobeta", "vtop="+v.getTop()+" padtop="+padTop);
                if (v == null) {
                    mScrolling = false;
                    return;
                } else {
            ...
            mPrevTime = mCurrTime;
            // WedroidLog.d("mobeta", "  updated prevTime="+mPrevTime);
