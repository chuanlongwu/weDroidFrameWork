...
public class WeDroidRequestPost extends WeDroidHttpRequest {
	 ...
	 * 提交表单数据
	 */
	public void postData(String uri, Map<String, String> params) {
		SKPostDataCore(uri, params, null);
	}

	/**
	 * 单个文件上传
	 */
	public void postFile(String uri, File file) {
		SKPostDataCore(uri, null, new File[] { file });
	}

	/**
	 * 单个文件上传带参
	 */
	public void postFile(String uri, Map<String, String> params, File file) {
		SKPostDataCore(uri, params, new File[] { file });
	}

	/**
	 * 多个文件上传
	 */
	public void postFiles(String uri, File[] files) {
		SKPostDataCore(uri, null, files);
	}

	/**
	 * 多个文件上传，并且带参数
	 */
	public void postFiles(String uri, Map<String, String> params, File[] files) {
		SKPostDataCore(uri, params, files);
	}
...
//					+ ":失败原因：" + e.getLocalizedMessage());
	...
	public void sendPost(String uri, Map<String, String> params, Map<String, String> headerParams) {
		...
		sendPostCore(params, post);
	}

	private void sendPostCore(Map<String, String> params, HttpPost post) {
		WeDroidRequestCallBack callBack = getBusinessCallBack();
		// 设置参数
